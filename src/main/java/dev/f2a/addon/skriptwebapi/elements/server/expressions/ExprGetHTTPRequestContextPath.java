...
@Name("Get HTTP request context path")
@Description("Retrieves context path from HTTP request")
...
public class ExprGetHTTPRequestContextPath extends SimpleExpression<String> {
    ...
    static {
        Skript.registerExpression(
                ...
                "[skweapi] (http|api) request (context path|context|path|contextpath) of %httpexchange%"
        );
    }
